...
-- end
-- }}}
awful.util.spawn_with_shell("feh --bg-scale " .. beautiful.wallpaper)


-- {{{ Tags
-- Define a tag table which will hold all screen tags.
tags = {
  names  = { "main", "www", "dev", "movie", "im", "other"},
  layout = { layouts[2], layouts[8], layouts[3], layouts[1], layouts[1],
             layouts[10]
}}
for s = 1, screen.count() do
